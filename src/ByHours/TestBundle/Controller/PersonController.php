...
use ByHours\TestBundle\Entity\Person;
use ByHours\TestBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ByHoursTestBundle:Person')->findAll();
     ...
     * @Method("POST")
     * @Template("ByHoursTestBundle:Person:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ByHoursTestBundle:Person')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ByHoursTestBundle:Person:edit.html.twig")
     */
