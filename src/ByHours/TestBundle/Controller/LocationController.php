...
use ByHours\TestBundle\Entity\Location;
use ByHours\TestBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ByHoursTestBundle:Location')->findAll();
     ...
     * @Method("POST")
     * @Template("ByHoursTestBundle:Location:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ByHoursTestBundle:Location')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ByHoursTestBundle:Location:edit.html.twig")
     */
