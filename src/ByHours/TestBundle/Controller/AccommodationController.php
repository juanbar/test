...
use ByHours\TestBundle\Entity\Accommodation;
use ByHours\TestBundle\Form\AccommodationType;
...
class AccommodationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ByHoursTestBundle:Accommodation')->findAll();
     ...
     * @Method("POST")
     * @Template("ByHoursTestBundle:Accommodation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ByHoursTestBundle:Accommodation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ByHoursTestBundle:Accommodation:edit.html.twig")
     */
