...
use ByHours\TestBundle\Entity\Description;
use ByHours\TestBundle\Form\DescriptionType;
...
class DescriptionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ByHoursTestBundle:Description')->findAll();
     ...
     * @Method("POST")
     * @Template("ByHoursTestBundle:Description:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ByHoursTestBundle:Description')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ByHoursTestBundle:Description:edit.html.twig")
     */
