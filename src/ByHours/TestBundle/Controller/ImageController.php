...
use ByHours\TestBundle\Entity\Image;
use ByHours\TestBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ByHoursTestBundle:Image')->findAll();
     ...
     * @Method("POST")
     * @Template("ByHoursTestBundle:Image:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ByHoursTestBundle:Image')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ByHoursTestBundle:Image:edit.html.twig")
     */
